            ...
            content: (
                <>
                    <p className="text-gray-600 mt-3">
                        A well-labeled floor plan ensures **maximum space utilization**.
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between px-8 md:px-16 lg:px-24 py-16 bg-gray-100">
            ...
            <div className="lg:w-1/3 text-left">
                ...
                <p className="text-lg text-gray-500 mt-3 italic leading-relaxed">
                    ...
                    <span className="text-red-600 font-semibold"> 3D Floor Plans</span>.
                    Every detail is crafted to perfection, ensuring **functionality & visual appeal**."
                </p>
                <p className="mt-6 text-xl font-medium text-gray-700">🏠 Floor Plan 3D</p>
            </div>
