  ...
  return (
    <section className="relative bg-white py-10 px-5 md:px-20">
      ...
      >
        ...
        <h1 className="text-3xl font-medium mt-3">
          <span className="relative inline-block">
            <span className="text-red-500">2D Floor Plans</span>
            <span className="absolute left-1/2 transform -translate-x-1/2 bottom-[-8px] w-24 h-[2px] bg-red-500"></span>
          </span>
        </h1>
      ...
      <motion.div
        ...
        className="mt-8 flex flex-wrap justify-center gap-16" // Changed to flex and justify-center
