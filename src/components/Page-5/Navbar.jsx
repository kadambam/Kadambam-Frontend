...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const heroSection = document.getElementById("hero-5");
      if (heroSection) {
        ...
        <div className="flex items-center justify-between h-full">
          <a href="#" className="h-full flex items-center">
            <img
              ...
              src={
                isScrolled || (isMobile && isOpen) ? "logo4black.png" : "logo4black.png"
              }
              alt="Logo"
            />
          </a>
          ...
          <div className="flex flex-col md:flex-row">
            <a
              className={`block my-2 md:mx-4 md:my-0 text-lg font-medium transition ${
                isMobile && isOpen ? "text-black hover:text-gray-600 bg-white px-4 py-2 rounded-md" : isScrolled ? "text-black hover:text-gray-600" : "text-black hover:text-gray-300"
              }`}
